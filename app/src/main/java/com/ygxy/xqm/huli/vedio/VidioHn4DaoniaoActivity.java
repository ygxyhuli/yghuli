...
public class VidioHn4DaoniaoActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vedio_wh4daoniao_activity);
        ButterKnife.bind(this);
        showVedio();
    }

    private void showVedio() {
        String url = OkHttpGetUtil.getVedioDR5Url;
    ...
    @OnClick({R.id.tv_error_a, R.id.tv_error_b, R.id.tv_error_c, R.id.tv_error_d,R.id.tv_error_e,R.id.vedio_submit})
