...
public class VidioHn8DaoniaoActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vedio_wh7daoniao_activity);
        ButterKnife.bind(this);
        showVedio();
    }

    private void showVedio() {
        String url = OkHttpGetUtil.getVedioDR9Url;
        ...
        switch (view.getId()) {
            ...
            case R.id.vedio_submit:
                ...
                if (select.equals(answer)) {
                    ...
                    intent.putExtra("from","VidioHn8DaoniaoActivity");
