...
public class VidioHn7DaoniaoActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vedio_wh6daoniao_activity);
        ButterKnife.bind(this);
        showVedio();
    }

    private void showVedio() {
        String url = OkHttpGetUtil.getVedioDR8Url;
    ...
    @OnClick({R.id.tv_error_a, R.id.tv_error_b, R.id.tv_error_c, R.id.tv_error_d,R.id.vedio_submit})
