...
public class VidioHWujunActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vedio_wh_activity);
        ...
        btnP1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String url = "http://onohffsqv.bkt.clouddn.com/%E6%97%A0%E8%8F%8C%E8%A7%86%E9%A2%91%E4%B8%80.mp4";
        ...
        btnP2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "http://onohffsqv.bkt.clouddn.com/%E6%97%A0%E8%8F%8C%E8%A7%86%E9%A2%91%E4%BA%8C.mp4";
                String imageUrl = OkHttpGetUtil.getVedioW1ImageUrl;
                String title = "完整版正确视频";
                videocontroller1.release();
                videocontroller1.setUp(url, imageUrl, title);
    ...
    private void showVedio() {
        String url = "http://onohffsqv.bkt.clouddn.com/%E6%97%A0%E8%8F%8C%E8%A7%86%E9%A2%91%E4%B8%80.mp4";
        String url1 = OkHttpGetUtil.vedioWR1Url;
        String imageUrl = OkHttpGetUtil.getVedioW1ImageUrl;
        String title = "完整版正确视频";
        videocontroller1.setUp(url, imageUrl, title);
