...
public class History {
    ...
    private int history_grade1;
    private int history_grade2;
...
//    }
    ...
    public int getHistory_grade1() {
        return history_grade1;
    }

    public void setHistory_grade1(int history_grade1) {
        this.history_grade1 = history_grade1;
    }

    public int getHistory_grade2() {
        return history_grade2;
    }

    public void setHistory_grade2(int history_grade2) {
        this.history_grade2 = history_grade2;
    }
