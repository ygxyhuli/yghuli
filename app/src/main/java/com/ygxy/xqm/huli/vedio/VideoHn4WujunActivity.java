...
import com.ygxy.xqm.huli.MainActivity;
...
public class VideoHn4WujunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_hn4_wujun);
        ButterKnife.bind(this);
        showVedio();
    }

    private void showVedio() {
        String url = OkHttpGetUtil.vedioWR5Url;
        ...
        switch (view.getId()) {
            ...
            case R.id.vedio_submit:
                ...
                if (select.equals(answer)) {
                    ...
                    intent.putExtra("from","VideoHn4WujunActivity");
